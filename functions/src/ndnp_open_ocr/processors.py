    ...
    def transfer_xmp(self):
        ...
        try:
            with exiftool.ExifToolAlpha() as et:
                ...
                if title_tag:
                    et.set_tags(
                        self.postprocessed_pdf, {"Title": title_tag, "XMP:Title-en": title_tag}
                    )
...
if __name__ == "__main__":
    processor = OCRProcessor(input_file_path="/Volumes/DLP1/notvalidated2/batch_dlc_sampleissue/data/2010270501/00237285074/1902103101/0865.tif", output_path="./")
