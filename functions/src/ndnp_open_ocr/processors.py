...
class OCRProcessor:
    ...
    def _preprocess_image(self):
        ...
        with Image.open(self.input_file_path) as img:
            ...
            if not self.full_height:
                ...
                gray_image.save(temp_gray_path)
    ...
    def postprocess_pdf(self):
        processor = PDFProcessor(self._get_old_pdf_path(), self._get_new_pdf_path())
